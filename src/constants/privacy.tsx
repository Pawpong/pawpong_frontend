...
export const privacyContents = [
  ...
  <div key={4} className="mb-5">
    ...
    <ol className="list-decimal" start={1}>
      <li className="ms-[21px]">회사는 원칙적으로 회원의 개인정보를 외부에 제공하지 않습니다.</li>
      <li className="ms-[21px]">단, 상담/입양 신청 시 신청자가 작성한 개인정보는 해당 브리더 회원에게 제공됩니다.</li>
      <li className="ms-[21px]">
        법령에 따라 수사기관이나 행정기관이 적법하게 요청하는 경우에는 예외적으로 제공될 수 있습니다.
      </li>
    </ol>
  </div>,
