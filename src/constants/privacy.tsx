...
export const privacyContents = [
  <div key={0} className="mb-5">
    <p>
      포퐁(이하 &quot;회사&quot;)은 「개인정보 보호법」 등 관련 법령을 준수하며,
      회원의 개인정보를 안전하게 보호하기 위해 다음과 같이 개인정보 처리방침을
      수립·공개합니다.
    </p>
  </div>,
  ...
  <div key={2} className="mb-5">
    ...
    <p>회사는 수집한 개인정보를 아래의 목적을 위해 이용합니다.</p>
    <ul className="list-disc">
      <li className="ms-[21px]">
        회원 식별 및 서비스 제공: 로그인, 마이페이지 이용, 서비스 접근 권한 관리
      </li>
      <li className="ms-[21px]">
        상담·입양 신청 처리: 브리더 회원에게 신청자의 정보를 전달하고, 상담 및
        입양 심사 과정 지원
      </li>
      <li className="ms-[21px]">
        서비스 운영 및 관리: 회원관리, 민원처리, 신고 처리, 분쟁 대응
      </li>
      <li className="ms-[21px]">
        보안 및 법령 준수: 부정 이용 방지, 법적 의무 이행
      </li>
    </ul>
  </div>,
  <div key={3} className="mb-5">
    ...
    <ol className="list-decimal" start={1}>
      <li className="ms-[21px]">회원가입 정보: 회원 탈퇴 시 즉시 파기</li>
      <li className="ms-[21px]">
        상담/입양 신청 정보: 상담 종료 또는 입양 확정 직후 파기
      </li>
      <li className="ms-[21px]">
        법령에 따른 보존: 관련 법령에 따라 일정 기간 보존이 필요할 경우 해당
        기간 동안 보관 후 즉시 파기
        <ul className="list-disc">
  ...
  <div key={4} className="mb-5">
    ...
    <ol className="list-decimal" start={1}>
      ...
      <li className="ms-[21px]">
        단, 상담/입양 신청 시 신청자가 작성한 개인정보는 해당 브리더 회원에게
        제공됩니다.
      </li>
      <li className="ms-[21px]">
        법령에 따라 수사기관이나 행정기관이 적법하게 요청하는 경우에는
        예외적으로 제공될 수 있습니다.
      </li>
    </ol>
  </div>,
  <div key={5} className="mb-5">
    <p>제5조 (개인정보 처리 위탁)</p>
    <p>
      회사는 개인정보 처리를 외부 업체에 위탁하지 않습니다. 다만 서비스 운영
      과정에서 필요할 경우, 위탁 사실과 범위를 사전에 고지하고 동의를 받습니다.
    </p>
  </div>,
  <div key={6} className="mb-5">
    ...
    <ol className="list-decimal" start={1}>
      <li className="ms-[21px]">
        파기 절차: 보유기간 종료 또는 처리 목적 달성 시 지체 없이 파기
      </li>
      <li className="ms-[21px]">
        파기 방법: 전자 파일은 복구 불가능한 방법으로 영구 삭제, 종이 문서는
        분쇄 또는 소각
      </li>
    </ol>
  </div>,
  <div key={7} className="mb-5">
    ...
    <ol className="list-decimal" start={1}>
      <li className="ms-[21px]">
        회원은 언제든지 자신의 개인정보를 열람, 수정, 삭제, 처리정지 요구할 수
        있습니다.
      </li>
      <li className="ms-[21px]">
        회원은 서비스 내 &apos;마이페이지&apos; 또는 고객센터를 통해 권리를
        행사할 수 있습니다.
      </li>
      <li className="ms-[21px]">
        만 14세 미만 아동 회원의 경우, 법정대리인이 위 권리를 행사할 수
        있습니다.
      </li>
    </ol>
  </div>,
  <div key={8} className="mb-5">
    ...
    <p>
      회사는 개인정보가 분실·도난·누출·위조·변조되지 않도록 다음과 같은 조치를
      취합니다.
    </p>
    <ul className="list-disc">
  ...
  <div key={10} className="mb-5">
    <p>제10조 (개정 및 고지 의무)</p>
    <p>
      본 개인정보처리방침은 시행일로부터 적용되며, 내용 추가·삭제·수정이 있을 시
      시행일 최소 7일 전부터 공지사항을 통해 안내합니다.
    </p>
    <ul className="list-disc">
      <li className="ms-[21px]">공고일자: 2025년 12월 23일</li>
