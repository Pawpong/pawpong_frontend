  ...
  return (
    <>
      <Dialog open={open} onOpenChange={handleOpenChange}>
        <DialogContent
          className="max-w-[37.5rem] w-full p-0 gap-0 overflow-hidden !rounded-2xl"
        ...
        >
          ...
          {/* 콘텐츠 영역 */}
          <div className="bg-[var(--color-tertiary-500)] flex flex-col gap-9 h-[452px] items-start overflow-x-clip overflow-y-auto pb-10 pt-6 px-6 relative shrink-0 w-full">
            {/* 제목 */}
            ...
            <div className="flex flex-col items-start relative shrink-0 w-full">
              {reportReasons.map((reason: ReportReason, index: number) => (
                <div
                  key={index}
                ...
                >
                  ...
                  {reason.value === "other" && isOtherSelected && (
                    <div className="bg-white flex flex-col items-start overflow-clip relative rounded-lg shrink-0 w-full mt-2">
                      <div className="box-border flex flex-col gap-4 items-start overflow-clip pb-0 relative shrink-0 w-full">
                        <Textarea
                          ...
                          className="min-h-[140px] font-medium leading-[24px] text-body-s w-full resize-none"
                        />
                      </div>
                    </div>
                  )}
          ...
          {/* 하단 버튼 영역 */}
          <div className="bg-white flex gap-[10px] items-start justify-end overflow-clip pb-6 pt-4 px-6 relative rounded-bl-2xl rounded-br-2xl shrink-0 w-full">
            <button
