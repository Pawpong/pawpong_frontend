...
import { TERMS_OF_SERVICE_INTRO, TERMS_OF_SERVICE_SECTIONS, TermsContentItem } from './constants';
    ...
    <Container className="pb-20 py-10 px-5 md:px-10">
      <div className="flex-1 @container flex flex-col gap-10 md:items-center">
        <div className="flex flex-col gap-6 max-w-[660px] w-full md:mx-auto">
          <div className="text-[#4F3B2E] text-heading-3 font-semibold">서비스 이용약관</div>
        </div>

        <div className="flex flex-col gap-5 max-w-[660px] w-full md:mx-auto">
          <p className="text-body-xs font-normal text-grayscale-gray6 leading-[1.43]">{TERMS_OF_SERVICE_INTRO}</p>
