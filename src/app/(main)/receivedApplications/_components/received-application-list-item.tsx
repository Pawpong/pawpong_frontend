    ...
    >
      ...
      >
        <div className="flex flex-col gap-1 items-start w-full">
          <p className="text-body-m font-medium text-primary-500 w-full">{applicantNickname}</p>
          <p className="text-body-s font-normal text-grayscale-gray5 truncate w-full">{animalInfo}</p>
        </div>
