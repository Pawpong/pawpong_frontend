...
export function NavigationGuardProvider({ children }: { children: ReactNode }) {
  const [guardNavigation, setGuardNavigation] = useState<((href: string) => void) | undefined>(undefined);
  ...
  return (
    <NavigationGuardContext.Provider value={{ guardNavigation, setGuardNavigation: updateGuardNavigation }}>
      {children}
